...
const services = [
  "Project Works & Execution",
  "Consultancy Services",
  "Project Management",
  "Risk Management",
  "Technology and Infrastructure Supports",
  "Studies, Investigations and Surveys",
  "Reports Preparation & Analytics",
]
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -right-10 bg-[rgba(44,160,160,1)] p-12 text-white hidden md:block">
              <span className="text-6xl font-bold block mb-2">15+</span>
          ...
          <div className="space-y-12">
            <div>
              ...
              <h3 className="text-4xl md:text-5xl font-bold mb-8">Comprehensive Technical Solutions</h3>
            ...
            <button className="bg-black text-white px-10 py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-[rgba(44,160,160,1)] transition-colors">
